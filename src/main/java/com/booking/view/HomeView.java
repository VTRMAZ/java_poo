...
import com.booking.view.CityAccommodationView;
    ...
    private JPanel createDestinationCard(String city, Color themeColor) {
        ...
        card.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                List<Accommodation> accommodations = accommodationController.getAccommodationsByCity(city);
                new CityAccommodationView(city, accommodations, null); // user == null ici car pas connecté
                dispose(); // Ferme HomeView
            }
        });
